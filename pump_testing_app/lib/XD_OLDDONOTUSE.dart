...
import './XD_ABOUT.dart';
import 'package:adobe_xd/page_link.dart';
import './XD_TRUCKSELECTION.dart';
import './XD_TRAININGVIDEOS.dart';
import './XD_HOME.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XD_OLDDONOTUSE extends StatelessWidget {
  XD_OLDDONOTUSE({
    Key key,
  }) : super(key: key);
  @override
                  ...
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(99.4, 37.0, 74.0, 31.0),
                          size: Size(414.0, 104.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child:
